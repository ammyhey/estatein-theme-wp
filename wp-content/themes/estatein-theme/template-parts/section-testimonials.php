...
<section class="content-section" id="testimonials">
	<div class="container-xl">
		...
		<?php if ($posts) : ?>
			<div class="estatein-slider" data-estatein-slider data-slides="3" role="region" aria-roledescription="carousel" aria-label="<?php echo esc_attr(estatein_field('testimonials_heading', false, 'What Our Clients Say')); ?>">
					...
					<?php foreach ($posts as $post) :
						...
						<div class="estatein-slide">
							<article class="testimonial-card card-reveal h-100">
								<div class="stars" role="img" aria-label="<?php echo esc_attr(sprintf(__('%d out of 5 stars', 'estatein'), $rating)); ?>">
								...
								<div class="client-meta">
									<?php
									$client_name = estatein_field('client_name', $pid, get_the_title($pid));
									$photo = estatein_image('client_photo', 'thumbnail', $pid, 'client-avatar', $client_name);
				...
				<?php estatein_slider_controls(estatein_button(estatein_field('testimonials_button_label', false, 'View All Testimonials'), estatein_nav_url(estatein_field('testimonials_button_url', false, '')), 'btn btn-view-all'), __('testimonials', 'estatein'), 'testimonials-slides'); ?>
			</div>
		<?php else : ?>
