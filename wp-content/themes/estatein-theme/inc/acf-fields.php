...
function estatein_register_acf_fields(){
  ...
  $group('global','Estatein — Global Settings',['page_template'=>'page-estatein-settings.php'],[
    ...
    $text('footer_col4_title','Footer Column 4 Title'),$text('footer_col4_link1','Footer Column 4 Link 1 Label'),$text('footer_col4_link1_url','Footer Column 4 Link 1 URL','url'),$text('footer_col4_link2','Footer Column 4 Link 2 Label'),$text('footer_col4_link2_url','Footer Column 4 Link 2 URL','url'),$text('footer_col4_link3','Footer Column 4 Link 3 Label'),$text('footer_col4_link3_url','Footer Column 4 Link 3 URL','url'),$text('footer_col4_link4','Footer Column 4 Link 4 Label'),$text('footer_col4_link4_url','Footer Column 4 Link 4 URL','url'),$text('footer_col4_link5','Footer Column 4 Link 5 Label'),$text('footer_col4_link5_url','Footer Column 4 Link 5 URL','url'),
