...
function estatein_assets() {
  ...
  wp_enqueue_style('estatein-style',get_template_directory_uri().'/assets/css/theme.css',['bootstrap'],'1.5.9');

  if (is_front_page()) {
    wp_enqueue_style('slick','https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css',[],'1.8.1');
    wp_enqueue_style('estatein-style-front',get_template_directory_uri().'/assets/css/front-page.css',['estatein-style','slick'],'1.5.9');
  ...
  wp_enqueue_script('estatein-main',get_template_directory_uri().'/assets/js/theme.js', is_front_page() ? ['jquery','slick'] : [], '1.5.0', true);
}
