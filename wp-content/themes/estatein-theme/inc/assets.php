...
function estatein_assets() {
  ...
  wp_enqueue_style('estatein-style',get_template_directory_uri().'/assets/css/theme.css',['bootstrap'],'1.6.3');
  ...
  wp_enqueue_script('estatein-main',get_template_directory_uri().'/assets/js/theme.js', is_front_page() ? ['jquery','slick'] : [], '1.6.1', true);
}
