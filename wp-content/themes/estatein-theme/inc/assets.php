...
function estatein_assets() {
  ...
  wp_enqueue_style('estatein-style',get_template_directory_uri().'/assets/css/theme.css',['bootstrap'],'1.4.0');

  if (is_front_page()) {
    wp_enqueue_style('slick','https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css',[],'1.8.1');
    wp_enqueue_style('estatein-style-front',get_template_directory_uri().'/assets/css/front-page.css',['estatein-style','slick'],'1.4.0');
    wp_enqueue_script('jquery');
    wp_enqueue_script('slick','https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js',['jquery'],'1.8.1',true);
  }

  if (is_page_template('page-contact.php')) {
    wp_enqueue_style('estatein-style-contact',get_template_directory_uri().'/assets/css/contact-page.css',['estatein-style'],'1.4.0');
  }

  wp_enqueue_script('bootstrap','https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js',[], '5.3.3',true);
  wp_enqueue_script('estatein-main',get_template_directory_uri().'/assets/js/theme.js', is_front_page() ? ['jquery','slick'] : [], '1.4.0', true);
}
